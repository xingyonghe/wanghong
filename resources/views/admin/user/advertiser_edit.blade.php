    ...
    <div class="col-lg-12">
        <section class="panel">
            ...
            <div class="panel-body">
                <div class=" form">
                    {!! Form::open(['url' => 'admin/advertiser/post','class'=>'cmxform form-horizontal tasi-form form-datas','autocomplete'=>'off']) !!}
                    ...
                    <div class="form-group ">
                        ...
                        <div class="col-lg-10">
                            <input class="form-control " placeholder="输入公司名称" type="text" name="company" value="{{ $info->company }}" />
                        </div>
                    </div>
                    <div class="form-group ">
