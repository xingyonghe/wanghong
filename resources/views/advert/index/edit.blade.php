...
@section('content')
    <div class="row">
        ...
        <div class="span9">
            ...
            <div class="span6">
                <form class="form-horizontal data-form" action="{{ route('advert.index.update') }}" metho="POST"/>
                    {{ csrf_field() }}
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input id="company" type="text" name="company" placeholder="请输入公司名称" value="{{$user->advertiser->company }}"/>
