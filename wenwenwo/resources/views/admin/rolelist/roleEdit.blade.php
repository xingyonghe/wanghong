                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body"  style="min-height:380px;">
                            <form class="form-horizontal" role="form" action="{{url('admin/access/saverole')}}" method="post">
                                ...
                                <input id="authority" name="authority" value="{{$info['authority']}}" type="hidden"/>
                                {{--修改表单--}}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" placeholder="权限组名称" name="name" value="{{$info['name']}}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" placeholder="权限组说明" name="remarks" value="{{$info['remarks']}}">
                                    </div>
                                </div>
