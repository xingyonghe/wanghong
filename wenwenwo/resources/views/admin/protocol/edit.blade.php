        ...
        <div class="panel-body">
            {!! Form::open(['url' => 'admin/protocol/update','class'=>'form-horizontal adminex-form']) !!}
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {!! Form::text('title', $info->title, array('class' => 'form-control','placeholder'=>'请填写协议标题')) !!}
                        @if ($errors->has('title'))
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {!! Form::textarea('content', $info->content, array('class' => 'form-control wysihtml5','placeholder'=>'请填写协议内容','rows'=>9)) !!}
