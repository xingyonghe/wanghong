...
@section('content')
    ...
    <section class="panel">
        ...
        <div class="panel-body">
            {!! Form::open(['url' => 'admin/reminder','class'=>'form-horizontal adminex-form']) !!}
                <div class="form-group">
                    <label class="col-sm-2 col-sm-2 control-label">提示语名称</label>
                    <div class="col-sm-10">
                        {!! Form::text('title', old('title'), array('class' => 'form-control','placeholder'=>'请填写提示语名称')) !!}
                        @if ($errors->has('title'))
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        {!! Form::text('name', old('name'), array('class' => 'form-control','placeholder'=>'请填写提示语标识，标识必须是由小写字母构成')) !!}
                        @if ($errors->has('name'))
                ...
                <div class="form-group">
                    <label class="col-sm-2 col-sm-2 control-label">提示语内容</label>
                    <div class="col-sm-10">
                        {!! Form::textarea('content', old('content'), array('class' => 'form-control wysihtml5','placeholder'=>'请填写提示语内容','rows'=>9)) !!}
